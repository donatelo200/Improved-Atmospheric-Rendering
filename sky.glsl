...
// Planet shadow on rings
    ...
    // ----------------------------------------------
            ...
            // NEW: Dim ringshine when an eclipse crosses the rings
            #ifdef ECL
                // 1. Calculate the sub-solar point on the ring plane
                // In sky.glsl, the ring normal is assumed to be the Y-axis.
                ...
                // sky.glsl uses Radiuses.y as the planetary scale factor for rings
                ...
                // 5. Also dim ringshine if the local sky fragment itself is occluded
                //ringIntensity *= max(Shadow, 0.0);
            #endif
            // =============================================
